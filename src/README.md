...
src
    + general                             | Package base general function
    + pet                                 | Package base Script
      + get                               | Package base Script GET service
      + post                              | Package base Script POST service
      + put                               | Package base Script PUT service
    + run-commandas                       | Package with commands to run different types of tests
    + baseURL                             | Package build the bases URL
